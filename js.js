...
let human1 = new Human("Jason", "actor", 47, "uk");
let human2 = new Human("Dwahne", "actor", 50, "UK");
let human3 = new Human("Mark", "actor", 51, "UK");
let human4 = new Human("Denzel", "actor", 67, "IK");
let human5 = new Human("Ryan", "actor", 85, "UK");
let human6 = new Human("Matthew", "actor", 76, "UK");
let human7 = new Human("John", "actor", 38, "UK");

let humans = [human1, human2, human3, human4, human5, human6, human7];
